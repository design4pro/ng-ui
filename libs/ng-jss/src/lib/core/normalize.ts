 ...
 *
 * NOTE:
 * 1. Dropped support of IE9. So, removed from original normalize rules, writtend specially for IE9
 * 2. Required jss plugins for correct working:
 *    2.1. jss-vendor-preifxer
 *    2.2. jss-camelcase
 * Anyway, you can use a preset (https://github.com/cssinjs/jss-preset-default) for a quick setup with default plugins.
 */

export function normalize(dynamic: boolean = false): StyleSheet {
  const styles: Object = {
    '@global': {
      /**
